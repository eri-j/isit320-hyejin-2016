...
define(['floors'], function(Floors) {
    ...
    function Control(threeInit) {
        ...
        var floors = new Floors(threeInit);
    ...
    function addCube(scene, camera, wireFrame, x, z) {
        var geometry = new THREE.BoxGeometry(1, 1, 0.9);
        ...
        addSphere(scene, camera, wireFrame, 0, -7);
    ...
    function addCubes(scene, camera, wireFrame) {
        for (var i = 0; i < 6; i++) {
            addCube(scene, camera, wireFrame, -1, -0.5 - i);
            addCube(scene, camera, wireFrame, 1, -0.5 - i);
        }
    }
